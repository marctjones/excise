...
/// rendering, and redaction remain permission-blind: excise's own internal
...
/// (the bit 10 accessibility carve-out) and break excise's core redaction
...
/// user password); the owner password unlocks everything. excise's decrypt
