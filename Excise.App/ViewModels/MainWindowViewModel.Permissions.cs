...
///
/// excise enforces ISO 32000-2 Table 22 permissions at the ACTION layer:
/// user-initiated copy, export, edit, form and annotation commands check
/// the document's <see cref="Excise.Core.Document.PdfDocument.EffectivePermissions"/>
...
/// gated — it is excise's core security purpose, and a document author's
...
/// full permissions. excise cannot yet verify owner passwords (#324), so
