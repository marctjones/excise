...
public class RecoverablePdfRenderingTests
{
    ...
    public void Render_AcrobatCompatibleV4R4ShortKeyPadding_RendersFirstPage(string fixture)
    {
        var path = TestRepoLayout.FindFile(fixture);
        Assert.SkipWhen(path == null, TestRepoLayout.AbsenceReason("pdf.js regression fixture", fixture));
