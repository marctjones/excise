...
public class HarakatNiqqudRedactionTests
{
    ...
    public void RedactText_VocalizedArabicNeedle_AlsoRemovesVocalizedWord()
    {
        ...
        var removed = doc.RedactText(VocalizedArabic, RedactionOptions.Default).VerifiedRemovals;
    ...
    public void RedactText_LatinCombiningAccents_AreNotStripped()
    {
        ...
        var removed = doc.RedactText("cafe", RedactionOptions.Default).VerifiedRemovals;
    ...
    public void RedactText_HebrewPunctuationInBlock_IsNotStripped()
    {
        ...
        var removed = doc.RedactText("\u05D0\u05D1\u05D2\u05D3", RedactionOptions.Default).VerifiedRemovals; // alef-bet-gimel-dalet, no maqaf
