...
└── Differential/                   # ← REFERENCE ORACLES. Use these, don't build new ones.
    ├── MutoolReferenceRenderer.cs        # 153 uses in Differential tests
    ├── GhostscriptReferenceRenderer.cs   #  61
    ├── PdftocairoReferenceRenderer.cs    #  46
    ...
    ├── PdfiumNativeReferenceRenderer.cs  # 10 uses — the REAL pdfium oracle (#857), see note below the map
    └── PdfBoxReferenceRenderer.cs        # 11 uses — see note below the map
